...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".horizontal-layout {\n  display: flex;\n  flex-direction: row;\n}\n\n.vertical-layout {\n  display: flex;\n  flex-direction: column;\n}\n\n.horizontal-layout-item, .vertical-layout-item {\n  flex: 1;\n}\n\n.error {\n  color: red;\n}\n\n.control {\n  display: flex;\n  flex-direction: column;\n}\n\n.control > .wrapper {\n  display: flex;\n}\n\n.control > .wrapper > input,\n.control > .wrapper > select,\n.control > .wrapper > textarea {\n  flex: 1\n}\n\n.control > .error,\n.control > .description {\n  min-height: 1.5em;\n}\n\n.array-list {\n  display: flex;\n  flex-direction: column;\n}\n\n.array-list-item-toolbar {\n  cursor: pointer;\n  display: flex;\n  justify-content: flex-end;\n  align-items: stretch;\n  margin: 0.2em 0;\n}\n\n.array-list-item-toolbar > button {\n  user-select: none;\n  cursor: pointer;\n}\n.array-list-item-toolbar > button:disabled {\n  cursor:initial;\n}\n\n.array-list-item-label {\n  background-color: rgb(238,238,238);\n  flex: 1;\n  padding-left: 0.5em;\n  height: 1.5em;\n  line-height: 1.5em;\n}\n.array-list-item-label:hover {\n  background-color: rgb(221, 221, 221);\n}\n\n.array-list-item-content {\n  display: none;\n  padding: 0 1em;\n}\n\n.array-list-item-content.expanded {\n  display: block;\n}", "",{"version":3,"sources":["webpack://./node_modules/@jsonforms/vue-vanilla/vanilla.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,OAAO;AACT;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,aAAa;AACf;;AAEA;;;EAGE;AACF;;AAEA;;EAEE,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,eAAe;EACf,aAAa;EACb,yBAAyB;EACzB,oBAAoB;EACpB,eAAe;AACjB;;AAEA;EACE,iBAAiB;EACjB,eAAe;AACjB;AACA;EACE,cAAc;AAChB;;AAEA;EACE,kCAAkC;EAClC,OAAO;EACP,mBAAmB;EACnB,aAAa;EACb,kBAAkB;AACpB;AACA;EACE,oCAAoC;AACtC;;AAEA;EACE,aAAa;EACb,cAAc;AAChB;;AAEA;EACE,cAAc;AAChB","sourcesContent":[".horizontal-layout {\n  display: flex;\n  flex-direction: row;\n}\n\n.vertical-layout {\n  display: flex;\n  flex-direction: column;\n}\n\n.horizontal-layout-item, .vertical-layout-item {\n  flex: 1;\n}\n\n.error {\n  color: red;\n}\n\n.control {\n  display: flex;\n  flex-direction: column;\n}\n\n.control > .wrapper {\n  display: flex;\n}\n\n.control > .wrapper > input,\n.control > .wrapper > select,\n.control > .wrapper > textarea {\n  flex: 1\n}\n\n.control > .error,\n.control > .description {\n  min-height: 1.5em;\n}\n\n.array-list {\n  display: flex;\n  flex-direction: column;\n}\n\n.array-list-item-toolbar {\n  cursor: pointer;\n  display: flex;\n  justify-content: flex-end;\n  align-items: stretch;\n  margin: 0.2em 0;\n}\n\n.array-list-item-toolbar > button {\n  user-select: none;\n  cursor: pointer;\n}\n.array-list-item-toolbar > button:disabled {\n  cursor:initial;\n}\n\n.array-list-item-label {\n  background-color: rgb(238,238,238);\n  flex: 1;\n  padding-left: 0.5em;\n  height: 1.5em;\n  line-height: 1.5em;\n}\n.array-list-item-label:hover {\n  background-color: rgb(221, 221, 221);\n}\n\n.array-list-item-content {\n  display: none;\n  padding: 0 1em;\n}\n\n.array-list-item-content.expanded {\n  display: block;\n}"],"sourceRoot":""}]);
// Exports
...
"use strict";
module.exports = JSON.parse('["application/json","application/yaml"]');
...
var dist = __webpack_require__(9753);
// EXTERNAL MODULE: ./node_modules/lodash/lodash.js
var lodash = __webpack_require__(6486);
// EXTERNAL MODULE: ./node_modules/@jsonforms/vue-vanilla/vanilla.css
var vanilla = __webpack_require__(3962);
...
const supportedMimeTypes = __webpack_require__(570);
// let ace
const JsonFormEditor = {
    ...
    _onSaveTrigger: function () {
        ...
        if (JsonFormEditor.saving) {
            ...
            JsonFormEditor.saving = true;
            JsonFormEditor.file.edited = false;
        }
        // Can any fade outs on the saving message
        clearTimeout(JsonFormEditor.saveMessageTimeout);
        ...
        // FIXME: null should be the data
        null, JsonFormEditor.file, function (data) {
            // Yay
            if (JsonFormEditor.file.edited == false) {
                document.title =
                    JsonFormEditor.file.name + ' - ' + JsonFormEditor.oldTitle;
                $('small.unsaved-star').css('display', 'none');
            }
            JsonFormEditor.file.mtime = data.mtime;
            JsonFormEditor.file.size = data.size;
            $message.text(t('files_jsonformeditor', 'Saved!'));
            JsonFormEditor.saveMessageTimeout = setTimeout(function () {
                $('small.saving-message').fadeOut(200);
            }, 2000);
        }, function (message) {
            // Boo
            if (typeof message == 'undefined') {
                $('small.saving-message').text(t('files_jsonformeditor', 'Failed!'));
            }
            else {
            ...
            JsonFormEditor.file.edited = true;
        });
    ...
    _onCloseTrigger: function () {
        ...
        if (!JsonFormEditor.file.edited) {
            ...
            JsonFormEditor.saveFile(
            // FIXME
            null, JsonFormEditor.file, function () {
                // @ts-ignore
                ...
                // @ts-ignore
                OC.Notification.showTemporary(t('files_jsonformeditor', 'There was a problem saving your changes. Click to resume editing.'));
                $('#notification')
                    .data('reopeneditor', true)
                    .on('click', JsonFormEditor._onReOpenTrigger);
                JsonFormEditor.file.edited = true;
            });
        }
    },
    ...
    registerFileActions: function () {
        supportedMimeTypes.forEach((mime) => {
            OCA.Files.fileActions.registerAction({
                ...
                displayName: t('files_jsonformeditor', 'Edit in JSON forms text editor'),
                mime: mime,
            ...
            OCA.Files.fileActions.setDefault(mime, 'edit_jsonformeditor');
        });
    },
    /**
    ...
    loadEditor: function (container, file) {
        ...
        container.html('<div id="editor_overlay"></div>' +
            '<div id="editor_container" class="icon-loading">' +
            '<div id="editor_wrap"><div id="filesjsonformeditor"></div>' +
        ...
        this.loadFile(file.dir, file.name, function (file, data) {
            ...
            // @ts-ignore
            OC.dialogs.alert(message, t('files_jsonformeditor', 'An error occurred!'));
            _self.closeEditor();
        });
    },
    ...
    loadControlBar: function (file) {
        var html = '<small class="filename">' +
            escape_html_default()(file.name) +
            '</small>' +
    ...
    setPreviewMode: function (mode) {
        var container = $('#app-content-jsonformeditor');
    ...
    bindControlBar: function () {
        $('#editor_close').on('click', lodash.bind(this._onCloseTrigger, this));
        $(window).resize(JsonFormEditor.setFilenameMaxLength);
    ...
    loadFile: function (dir, filename, success, failure) {
        fetch((0,dist/* generateUrl */.nu)('/apps/files_jsonformeditor/ajax/loadfile?' +
            new URLSearchParams({
                filename: filename,
                dir: dir,
            })), {
            ...
            JsonFormEditor.file.writeable = data.writeable;
            JsonFormEditor.file.mime = data.mime;
            JsonFormEditor.file.mtime = data.mtime;
            success(JsonFormEditor.file, data.filecontents);
        });
    },
    /**
    ...
    saveFile: function (data, file, success, failure) {
        ...
        fetch((0,dist/* generateUrl */.nu)('/apps/files_jsonformeditor/ajax/savefile'), {
            method: 'PUT',
            headers: {
    ...
    setupAutosave: function () {
        ...
        this.saveTimer = setTimeout(JsonFormEditor._onSaveTrigger, 3000);
    },
    /**
    ...
    _onClickDocument: function (event) {
        ...
        if (!$(event.target).closest('#editor_container').length &&
            !$(event.target).closest('.oc-dialog').length) {
            // Edit the editor
            JsonFormEditor._onCloseTrigger();
        }
    },
    /*
...
;// CONCATENATED MODULE: ./src/newfileplugin.js
...
/* provided dependency */ var src_$ = __webpack_require__(9755);
/// <reference types="@nextcloud/typings" />
...
src_$(document).ready(function () {
    src_$('#editor').remove();
    OCA.Files_JsonFormEditor.initialize(src_$('<div id="app-content-jsonformeditor"></div>'));
});
